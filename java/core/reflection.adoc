...
[.fragment]
image:/assets/img/java/core/reflection/reflection-juggling.webp[Reflection juggling]
...
[.fragment]
image:/assets/img/java/core/reflection/reflection-structure.gif[Reflection Structure]
