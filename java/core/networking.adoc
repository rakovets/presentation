...
image::/assets/img/java/core/networking/network-model.png[Network model]

=== OSI vs. TCP/IP

image::/assets/img/java/core/networking/logical-mapping-between-OSI-and-TCP-IP.png[Logical mapping between OSI and TCP/IP]
