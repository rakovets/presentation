...
[.fragment]
image::../../assets/img/java/core/oop/classes-and-objects/without-relations.png[Without relations]

=== Aggregation

[.fragment]
image::../../assets/img/java/core/oop/classes-and-objects/aggregation.png[Aggregation]
