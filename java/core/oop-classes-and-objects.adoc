...
[.fragment]
image::/assets/img/java/core/oop/classes-and-objects/encapsulation.png[Encapsulation]

=== Encapsulation

[.fragment]
image::/assets/img/java/core/oop/classes-and-objects/encapsulation-example.png[Encapsulation example]
