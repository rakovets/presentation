...
asciidoctor.convertFile('./java/core/conditional-statements.adoc', options)
asciidoctor.convertFile('./java/core/loops.adoc', options)
asciidoctor.convertFile('./java/core/arrays.adoc', options)
asciidoctor.convertFile('./java/core/oop-classes-and-objects.adoc', options)
asciidoctor.convertFile('./java/core/strings.adoc', options)
asciidoctor.convertFile('./java/core/oop-inheritance-and-polymorphism.adoc', options)
asciidoctor.convertFile('./java/core/class-object.adoc', options)
asciidoctor.convertFile('./java/core/generics.adoc', options)
asciidoctor.convertFile('./java/core/enum.adoc', options)
asciidoctor.convertFile('./java/core/collections.adoc', options)
asciidoctor.convertFile('./java/core/exception-handling.adoc', options)
asciidoctor.convertFile('./java/core/java-io.adoc', options)
asciidoctor.convertFile('./java/core/concurrency-common.adoc', options)
asciidoctor.convertFile('./java/core/concurrency-thread-synchronization.adoc', options)
asciidoctor.convertFile('./java/core/concurrency-utilities.adoc', options)
asciidoctor.convertFile('./java/core/functional-interfaces.adoc', options)
